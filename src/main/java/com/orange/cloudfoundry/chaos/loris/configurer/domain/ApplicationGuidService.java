 ...
 * @author O. Orand
 */
public interface ApplicationGuidService {


    CfApplicationResponse retrieveGuid(CfApplicationRequest cfAppInfo);

    Map<CfApplicationRequest, CfApplicationResponse> retrieveGuid (@NotNull Map<String,Organization> organizations);
