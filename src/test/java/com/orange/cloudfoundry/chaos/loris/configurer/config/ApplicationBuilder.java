...
public class ApplicationBuilder {
    private static AtomicInteger appCounter = new AtomicInteger(1);

    public static Application defaultApp() {
        Application application = new Application();
        application.setChaosProbability(0.6f);
        application.setScheduleName("atNoon");
        application.setGuid(UUID.randomUUID().toString());
        application.setName("app-" + appCounter.getAndIncrement());
        return application;
    }
